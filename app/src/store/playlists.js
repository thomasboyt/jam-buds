...
export const actions = {
  ...
  async loadNextPlaylistPage(context, { key } = {}) {
    ...
    const previousTimestamp = previousItem ? previousItem.timestamp : undefined;
  ...
  addPlaylistResources(context, { items, profiles }) {
    context.commit('playlistItems/addPlaylistItems', items, { root: true });
    if (profiles) {
      context.commit('profiles/addProfiles', profiles, { root: true });
    }
  },
