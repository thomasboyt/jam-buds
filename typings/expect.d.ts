// This is vendored from DefinitelyTyped until the following PR is merged:
// https://github.com/DefinitelyTyped/DefinitelyTyped/pull/12869
...
declare module "expect" {
  ...
  function expect(actual:any): expect.Expectation;
